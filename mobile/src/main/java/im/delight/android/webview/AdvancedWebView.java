...
import com.btxapp.pyraminxalgo.utility.ImageCaptureHelper;
import com.btxapp.pyraminxalgo.utility.LocationUtility;
		...
		super.setWebChromeClient(new WebChromeClient() {
			...
			public void onGeolocationPermissionsShowPrompt(String origin, Callback callback) {
				if (mGeolocationEnabled) {
					...
					if (!LocationUtility.isLocationEnabled(AdvancedWebView.this.getContext())) {
						LocationUtility.showLocationSettingsPrompt(AdvancedWebView.this);
					}
				}
				else {
					if (mCustomWebChromeClient != null) {
