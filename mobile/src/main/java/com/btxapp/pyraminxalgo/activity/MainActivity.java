package com.btxapp.pyraminxalgo.activity;
...
import com.btxapp.pyraminxalgo.ads.AdMobGdprHelper;
import com.btxapp.pyraminxalgo.ads.AdMobInterstitialHelper;
import com.btxapp.pyraminxalgo.utility.IntentUtility;
import com.btxapp.pyraminxalgo.utility.Preferences;
import com.robotemplates.kozuza.Kozuza;
import com.robotemplates.webviewapp.R;
import com.btxapp.pyraminxalgo.WebViewAppConfig;
import com.btxapp.pyraminxalgo.fragment.MainFragment;
import com.btxapp.pyraminxalgo.listener.DrawerStateListener;
import com.btxapp.pyraminxalgo.listener.LoadUrlListener;
...
public class MainActivity extends AppCompatActivity implements LoadUrlListener, DrawerStateListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// gdpr
		AdMobGdprHelper adMobGdprHelper = new AdMobGdprHelper(this, WebViewAppConfig.ADMOB_PUBLISHER_ID, WebViewAppConfig.GDPR_PRIVACY_POLICY_URL);
	...
	private void checkRateCounter() {
		...
		if (showMessage) {
			Snackbar
					...
					.setAction(R.string.main_rate_confirm, new View.OnClickListener() {
						@Override
						public void onClick(View view) {
