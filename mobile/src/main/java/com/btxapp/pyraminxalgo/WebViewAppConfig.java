package com.btxapp.pyraminxalgo;

import com.btxapp.pyraminxalgo.view.PullToRefreshMode;
import com.robotemplates.webviewapp.BuildConfig;

public class WebViewAppConfig {
	// Envato purchase code
	public static final String PURCHASE_CODE = "ec64b441-149e-4a41-b602-8f4253f7ac8d";
	...
	public static final String ADMOB_PUBLISHER_ID = "pub-8000753265338627";
	public static final String ADMOB_APP_ID = "ca-app-pub-6770392731333539~4508946377";

	// unit ids for AdMob,
	// leave these constants empty if you do not want to use AdMob
	public static final String ADMOB_UNIT_ID_BANNER = "ca-app-pub-8000753265338627/5248480268";
	public static final String ADMOB_UNIT_ID_INTERSTITIAL = "ca-app-pub-8000753265338627/9562619046";
	...
	public static final String GDPR_PRIVACY_POLICY_URL = "https://play.google.com/store/apps/details?id=com.ollalgorithms.btxapp";
