package com.btxapp.pyraminxalgo.fcm;
...
import com.btxapp.pyraminxalgo.activity.MainActivity;
...
public class WebViewAppFirebaseMessagingService extends FirebaseMessagingService {
	...
	public void onMessageReceived(RemoteMessage remoteMessage) {
		...
		if (remoteMessage.getNotification() != null) {
			...
			if (remoteMessage.getData() != null && remoteMessage.getData().get("url") != null) {
